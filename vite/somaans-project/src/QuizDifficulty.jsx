  ...
  return (
    <div className="quiz-page-container">
      <div className="quiz-content">
        <div className="quiz-header">
          <div className="intro-section">
            ...
            <p className="intro-text">Test your skills on social-engineering threats by taking one of these quizzes</p>
          </div>
        </div>
            ...
            <div className="quiz-option-content">
              <div className="quiz-option-title">
                <div className="quiz-icon-wrapper intermediate">
                  <FontAwesomeIcon icon={faGraduationCap} className="quiz-icon" />
                </div>
                <h3>Intermediate</h3>
              </div>
              <p className="quiz-description">
            ...
            <div className="quiz-option-content">
              <div className="quiz-option-title">
                <div className="quiz-icon-wrapper advanced">
                  <FontAwesomeIcon icon={faChalkboardTeacher} className="quiz-icon" />
                </div>
                <h3>Advanced</h3>
              </div>
              <p className="quiz-description">
      ...
      <div className="bottom-section">
        <p className="not-ready-text">Not ready for a quiz? Try these instead:</p>
        <div className="alternative-buttons">
          <button className="alt-button dashboard" onClick={() => navigate('/dashboard')}>
            <FontAwesomeIcon icon={faArrowLeft} />
            Return to Dashboard
          </button>
          <button className="alt-button achievements" onClick={() => navigate('/achievements')}>
            <FontAwesomeIcon icon={faTrophy} />
            View Your Achievements
          </button>
          <button className="alt-button statistics" onClick={() => navigate('/statistics')}>
